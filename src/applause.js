...
//
// Author:
//   joshfrench, rjanardhana (ported to hubot-script package)
...
module.exports = robot =>
  robot.respond(/applau(d|se)|bravo|sarcastic applause|(slow|sarcastic) clap/i, function(msg) {
    const type = (/sarcastic/i).test(msg.message.text) ? images.insincere : images.sincere;
    return msg.send(msg.random(type));
  })
;
